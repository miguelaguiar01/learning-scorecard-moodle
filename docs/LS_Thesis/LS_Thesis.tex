...
In the latest version of the Learning Scorecard, version 2.0, the technological stack consisted of a React frontend that communicated with an Express (NodeJS) backend, the backend, in turn communicated through REST with a virtual machine hosted in Azure to a NoSQL mongoDB database and a graphDB. The main platform was hosted in Heroku. 
\begin{figure}[h]
  \centering
