...
class xp_calculator {
     ...
     */
    public static function calculate_base_with_grade_bonus($count, $base_xp, $avg_grade, $grade_multiplier) {
     ...
     */
    public static function calculate_exercise_xp($count, $base_xp, $avg_grade_percent, $grade_multiplier) {
        $base_total = $count * $base_xp;
     ...
     */
    public static function calculate_grade_percentage($grade, $max_grade) {
        if ($max_grade <= 0) {
            return 0;
        }
     ...
     */
    public static function calculate_weighted_average($grades_and_counts) {
     ...
     */
    public static function round_xp($xp) {
        return round($xp);
    }
}
?>
