...
class leaderboard_controller
{
     ...
     */
    public static function get_all_leaderboard($courseid): array
    {
     ...
     */
    public static function get_quiz_leaderboard($courseid): array
    {
     ...
     */
    public static function get_exercise_leaderboard($courseid): array
    {
        $context = \context_course::instance($courseid);
        $students = get_enrolled_users($context, 'mod/quiz:attempt');
     ...
     */
    public static function get_combined_leaderboard($courseid): array
    {
        ...
        foreach ($all_userids as $userid) {
            ...
            $all_pos = $all_positions[$userid] ?? $max_position;
            $quiz_pos = $quiz_positions[$userid] ?? $max_position;
            $exercise_pos = $exercise_positions[$userid] ?? $max_position;
     ...
     */
    public static function get_leaderboard_by_type($courseid, $type): array
    {
        switch ($type) {
            case 'all':
     ...
     */
    public static function get_leaderboard_stats($courseid): array
    {
        $context = \context_course::instance($courseid);
        $students = get_enrolled_users($context, 'mod/quiz:attempt');
