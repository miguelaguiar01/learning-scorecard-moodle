...
class student_xp {
     ...
     */
    public static function get_student_total_xp($userid, $courseid) {
     ...
     */
    public static function get_student_xp_breakdown($userid, $courseid) {
        global $DB;
     ...
     */
    public static function get_all_students_xp($courseid) {
     ...
     */
    public static function get_student_positions($userid, $courseid) {
        // This would be implemented by the leaderboard controller
     ...
     */
    public static function get_student_activity_summary($userid, $courseid) {
